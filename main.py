...
# Removed FFMPEG_BINARY logic as it's not strictly needed for AssemblyAI-only transcription (but kept the variable for safety if needed later).
...
def transcribe_file_with_assemblyai(input_file_path,language_code):
    ...
    if language_code!="en": config["language_code"]=language_code # Set lang code if not English
