...
def handle_media_common(message,bot_obj,bot_token):
    ...
    # Kani waa qaybta la beddelay. Waxaan ka saarnay hubinta file_size > TELEGRAM_MAX_BYTES.
    # Wuxuu hadda awood u leeyahay inuu soo dejisto files ka waaweyn 20MB isagoo isticmaalaya streaming download.
    # Xaddidaadda dhabta ah waxay noqon doontaa max file size ee Telegram (2GB) ama AssemblyAI.
